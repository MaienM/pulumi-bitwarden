...
export class Attachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bitwarden:index/attachment:Attachment';
     ...
     * Size as string
     */
    public /*out*/ readonly sizeName!: pulumi.Output<string>;
    /**
     * URL
     */
    ...
    constructor(name: string, argsOrState?: AttachmentArgs | AttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["sizeName"] = state ? state.sizeName : undefined;
            ...
            resourceInputs["sizeName"] = undefined /*out*/;
